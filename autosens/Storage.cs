            ...
            gamesList = new List<Game>
                {
                    ...
                    new Game { name = "Valorant", conversionCalc = "8.164 / [cm]", reverseCalc = "8.164 / [sens]", configPathTemplate = "[LOCALAPPDATA]\\VALORANT\\Saved\\Config\\[UNKNOWN]\\Windows\\RiotUserSettings.ini", replacementText = "MouseSensitivity=", configPath = " ", currentSensitivity = "0.0", notFoundText = "Valorant stores sensitivity in the cloud, and the local file is only written to, not read from.\nYour sensitivity should be: [SENS].", allowUpdate = false, userUpdatedPath = false},
                    ...
                    new Game { name = "GUNDAM EVOLUTION", conversionCalc=  "1469.7184 / [cm]", reverseCalc= "1469.7184 / [sens]", configPathTemplate= "subscribe to sillynov on youtube", replacementText= "and follow me on twitter", configPath= " ", currentSensitivity= "0.0", notFoundText= "This game does not have a local config file for the sensitivity as far as I know. \nYour sensitivity should be: [SENS]", allowUpdate= false, userUpdatedPath= false}
                };
